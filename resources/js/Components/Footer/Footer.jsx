...
const Footer = ({ theme }) => {
  return (
    <div className="bg-gray-100 dark:bg-black text-black dark:text-white mt-14 rounded-t-3xl">
      <section className="container">
        <div className="grid md:grid-cols-3 py-5">
          {/* Company Details */}
          <div className="py-8 px-4">
            <h1 className="sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3 font-serif dark:text-white">
              Car Rental
            </h1>
